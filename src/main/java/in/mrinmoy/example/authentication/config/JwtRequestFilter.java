...
// only the Token
        if (requestTokenHeader != null && requestTokenHeader.startsWith("Bearer ")) {
            ...
            try {
                Token availableToken = tokenRepository.findByToken(jwtToken).orElseThrow(() -> ExceptionUtil.getException("Invalid token provided.", "Please provide valid token and try again", HttpStatus.BAD_REQUEST));
