...
public class FileService {
    ...
    public void FileStorageService() throws CustomException {
        try {
            ...
            // throw ExceptionUtil.getException("Could not create the directory where the uploaded files will be stored.","Check
            // logs for more details", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public String storeFile(MultipartFile file) throws CustomException {
        ...
        if (fileName.contains("..")) {
            ...
            throw ExceptionUtil.getException("Sorry! Filename contains invalid path sequence " + fileName, "Provide valid file path",
