...
public class JwtTokenUtil implements Serializable {
    ...
    public User getUserDetailsFromToken(String token) throws CustomException {
        ...
        return userRepository.findByUsername(userName).orElseThrow(() -> ExceptionUtil.getException("Invalid userId provided.", "Please provide valid user id and retry.", HttpStatus.BAD_REQUEST));
    }
